...
Designfaget manglar ein grammatikk. «Form følgjer funksjon» forklarte alt
og difor ingenting. Utan felles grammatikk har faget ingen intern måte å
seie *nei* til det som ikkje skal lagast.

## Rammeverket i éi setning

**Form er ein posisjon i eit rom av moglegheiter, forma av samtidige
...
| Omgrep | Funksjon |
|---|---|
| Formrom (1.3) | Alle moglege konfigurasjonar; vert oppdaga, ikkje konstruert |
