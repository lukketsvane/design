...
| Maaltal | Krav | d-vridd | e-drope | f-timeglas |
|---|---|---|---|---|
| Fro | loggfort | 101 | 202 | 303 |
| Ribber | - | 44 | 40 | 40 |
| Twist | - | 112 grader | 0 grader | 115 grader |
| Vasstett solid | ja | True | True | True |
| Masse (PLA 1,24 g/cm3) | < 150 g | 89 g | 98 g | 96 g |
| Masse (PETG 1,27 g/cm3) | < 150 g | 91 g | 101 g | 98 g |
| Overheng maks (skal) | < 50.0 grader | 45.0 grader | 45.0 grader | 45.0 grader |
| Skalareal over budsjett | < 1 % | 0.00 % | 0.00 % | 0.00 % |
| Ribbekant-drift (analytisk) | < 50.0 grader | 46.2 grader | 11.9 grader | 45.4 grader |
| Bru, maks slissespenn | <= 8.0 mm | 4.3 mm | 7.4 mm | 6.6 mm |
| Opningsgrad heile flata | 25-45 % maal | 31 % | 24 % | 26 % |
| Storste radius | <= 110.0 mm | 85.0 mm | 106.4 mm | 91.9 mm |
| Hogd | - | 240 mm | 240 mm | 240 mm |
| Fil | - | `print/vase-d-vridd.3mf` | `print/vase-e-drope.3mf` | `print/vase-f-timeglas.3mf` |
